...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pulseboard generates and posts three on-brand ads a day across Facebook, Instagram, and TikTok. Start your free trial." },
      { property: "og:title", content: "Pulseboard — Automate Your Ads on Autopilot" },
      { property: "og:description", content: "Three on-brand posts a day, planned and scheduled across every channel — while you focus on your business." },
    ...
    <div className="min-h-screen bg-background text-foreground antialiased">
      <header className="sticky top-0 z-20 border-b border-border bg-background/90 backdrop-blur-sm">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-5">
          ...
          <Link
            to="/onboarding"
            className="inline-flex h-9 items-center rounded-xl bg-primary px-4 text-[13px] font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:bg-primary/90 hover:shadow-primary/40 hover:-translate-y-0.5"
          >
            Start Free Trial
          </Link>
        </div>
      ...
      <main className="mx-auto max-w-5xl px-5">
        <Reveal as="section" className="py-16 text-center sm:py-24" y={32}>
          ...
          <p className="mx-auto mt-4 max-w-xl text-[15px] leading-relaxed text-muted-foreground sm:text-lg">
            Three on-brand posts a day, planned and scheduled across every channel — while you focus on running your business.
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              to="/onboarding"
              className="inline-flex h-12 items-center gap-2 rounded-xl bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:bg-primary/90 hover:shadow-primary/40 hover:-translate-y-0.5"
            >
        ...
        <Reveal as="section" className="pb-16" delay={0.05}>
        ...
        <Reveal as="section" className="pb-16" delay={0.05}>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {features.map((feature, i) => {
              ...
              return (
                <div key={feature.title} className="rounded-2xl border border-border bg-card p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
                  <span className="grid size-9 place-items-center rounded-xl bg-primary/15 text-primary">
                    <Icon className="size-4" />
                  </span>
                  <h3 className="mt-3 text-[15px] font-semibold">{feature.title}</h3>
                  <p className="mt-1 text-[13.5px] leading-relaxed text-muted-foreground">{feature.description}</p>
                </div>
              );
            })}
          </div>
        ...
        <Reveal as="section" className="grid grid-cols-3 gap-2 pb-16 sm:gap-3" delay={0.05}>
          {stats.map((stat) => (
        ...
        <Reveal as="section" className="pb-20 text-center" delay={0.05}>
          <div className="rounded-2xl border border-border bg-card p-8 shadow-sm sm:p-12">
            ...
            <Link
              to="/onboarding"
              className="mt-6 inline-flex h-12 items-center gap-2 rounded-xl bg-primary px-6 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:bg-primary/90 hover:shadow-primary/40 hover:-translate-y-0.5"
            >
              Start Free Trial <ArrowRight className="size-4" />
            </Link>
          </div>
