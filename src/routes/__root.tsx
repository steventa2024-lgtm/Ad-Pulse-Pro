  ...
  head: () => ({
    meta: [
      ...
      { title: "Pulseboard — Automate Your Ads on Autopilot" },
      {
        name: "description",
        content:
          "Pulseboard generates and posts three on-brand ads a day across Facebook, Instagram, and TikTok.",
      },
      { name: "author", content: "Pulseboard" },
      { property: "og:title", content: "Pulseboard — Automate Your Ads on Autopilot" },
      {
        property: "og:description",
        content: "Three on-brand posts a day, planned and scheduled across every channel.",
      },
